            ...
            <div id="tudo">
                <%
                    if (null != request.getParameter("confirmar")) {
                        ...
                        try {
                            result = rTransacao.incluir(reservas);
                        } catch (Exception e) {
                        }
                        if (result) {
                            // avisar usuario que transacao foi feita com sucesso
%>
                <form  id="contentRight" action="./Cliente_alterarReserva.html" method="post">
                ...
                %>
                <form id="contentRight" method="post">
                    <table>
                        <tr>
                            <th>
                                Estacionamento
                        ...
                        <tr>
                            <th>
                                ...
                                <p>Não sabe qual veículo escolher? Confira nossa <a href="./Cliente_visualizarFrota.jsp">frota disponível</a>!<br>
                                </p>
                </form>
                <%}%>
