                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><strong>VeÃ­culo</strong></th>
                                 <th><strong>LocalizaÃ§Ã£o</strong></th>
...
ModelosDO modeloDoVeiculo=new ModelosDO();
        int idModelo=veiculoAtual.getModeloID();
                ...
                Deseja desbloquear o veÃ­culo <%= modeloDoVeiculo.getModelo()%>?
                ...
                Deseja bloquear o veÃ­culo <%= modeloDoVeiculo.getModelo()%>?
