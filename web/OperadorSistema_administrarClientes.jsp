...
bloqueia e desbloqueia um cliente entrando com seu nome na primeira tela e confirmando o nome a segunda 
--%>
        ...
        <div id="base">
            ...
            <div id="tudo">
                ...
                <form id="contentRight" action="./OperadorSistema_administrarClientes.jsp" method="post">
                    Insira o Nome do Cliente a ser bloqueado ou desbloqueado
                    <table>
                        <tr>
